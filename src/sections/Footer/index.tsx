...
export default function () {
  ...
  return (
    <footer className="px-4 py-5 sm:px-20 lg:px-40 max-w-[2000px] m-auto space-y-5">
      <div className="border-b border-black flex flex-col sm:flex-row justify-between items-center gap-4 py-5">
        <span>SAIDA Haithem</span>
        ...
        <div className="inline-flex gap-4">
          <CTA
            variant={"outline"}
            link="https://www.linkedin.com/in/haithem-saida-b993741b5/?jobid=1234"
            icon={
              <svg
          ...
          <CTA
            variant={"outline"}
            link="https://github.com/haithem-ss"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
      ...
      <div className="mt-10">© 2023 SAIDA haithem. All rights reserved.</div>
    </footer>
  );
}
